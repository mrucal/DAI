...
def restaurante():
	append_historial('/restaurantes', 'Restaurantes')
	...
	if request.method == 'POST':
		...
		opciones=obtener_posibles_valores(cursor,campo)
		...
		h = get_history()
		if tb == 'cocina':
			return render_template('restaurantes.html',username =  session['username'], h = h, opciones = opciones, busqueda = True, encontrados = encontrados, total = len(encontrados), tb= tb, opcion = opcion)
		else:
			return render_template('restaurantes.html',username =  session['username'], h = h, opciones = opciones, busqueda = True, encontrados = encontrados, total = len(encontrados), tb= tb, opcion = opcion, nococina = True)
...
def obtener_posibles_valores(cursor, nombre_campo):
	campo = set()
